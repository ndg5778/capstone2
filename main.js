                  ...
                  <div class="shop-category nav navbar-nav navbar-left">
                      ...
                      <div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                              <li id="btn"><a href="">Wallpaper</a></li>
                              <li id="btn"><a href="">Veneer</a></li>
                          </ul>
                      </div>
                  </div>
                  <div class="shop-category nav navbar-nav navbar-left">
                      ...
                      <div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                              <li id="btn"><a href="">Chair</a></li>
                              <li id="btn"><a href="">Desk</a></li>
                              <li id="btn"><a href="">Bed</a></li>
                              <li id="btn"><a href="">Sofa</a></li>
                              <li id="btn"><a href="">Closet</a></li>
                              <li id="btn"><a href="">Light</a></li>
                              <li id="btn"><a href="">Other</a></li>
                          </ul>
                      </div>
                  </div>
                  <div class="shop-category nav navbar-nav navbar-left">
                      ...
                      <div class="btn-group">
                          <button type="button" class="btn btn-shop-category dropdown-toggle" data-toggle="dropdown"
                              aria-haspopup="true" aria-expanded="false">
                              VR Service <span class="caret"></span>
                          </button>
                          <ul class="dropdown-menu">
